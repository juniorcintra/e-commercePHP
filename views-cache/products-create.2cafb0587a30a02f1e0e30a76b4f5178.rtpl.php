...
<script type="text/javascript">
  ...
  function updateOrder(){
    var string1 = document.getElementById("desproduct").value; 

    var string = string1.replace('"', "");

    var retorno = string.split(" ");

    var juntar = retorno.join('-');

    var result = juntar.replace(".", "-");

    var low = result.toLowerCase();

    document.getElementById("desurl").value = low;
  }
